...
<div class="share-sidebar">
    ...
    <ul class="share list-group">
        <li class="list-group__item">
            <a target="_blank" href="<?php echo $facebook ?>" class="button button--regular button--fb"><span><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/icon-facebook.svg" alt="Ikon för Facebook"> Dela på Facebook</span></a>
        </li>
        <li class="list-group__item">
            <a target="_blank" href="<?php echo $twitter ?>" class="button button--regular button--twitter"><span><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/icons/icon-twitter.svg" alt="Ikon för Twitter"> Dela på Twitter</span></a>
        </li>
    </ul>
</div>
